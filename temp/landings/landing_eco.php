...
<body>
    ...
    <div class="swiper pageSwiper" data-js-fullScreen-slider>
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="eco-slide">
                    ...
                    <div class="content font-gotham">
                        ...
                        <div class="swiper textSwiperF" data-js-swiper-scrollblock>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
            ...
            <div class="swiper-slide">
                <div class="eco-slide" id="e2">
                    <div class="main_img eco-2"></div>
                    <div class="content font-gotham">
                        <p class="subtitle">Экопроекты</p>

                        <div class="swiper textSwiperS" data-js-swiper-scrollblock>
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
